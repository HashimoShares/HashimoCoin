// Copyright (c) 2014 The Hashimocoin developers
...
void ThreadSecureMsg(void* parg)
{
    ...
    RenameThread("hashimocoin-smsg"); // Make this thread recognisable
...
void ThreadSecureMsgPow(void* parg)
{
    ...
    RenameThread("hashimocoin-smsg-pow"); // Make this thread recognisable
