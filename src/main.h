...
#define BLOCK_START_MASTERNODE_PAYMENTS_TESTNET 5 // Testnet Masternode payments enabled block 81k5
#define BLOCK_START_MASTERNODE_PAYMENTS 5001 //Mainnet Masternode payments not enabled until block 645k
...
static const int64_t DARKSEND_COLLATERAL = (10000*COIN); // 10,000 HSC
static const int64_t DARKSEND_FEE = (0.010000*COIN); //0.01 HSC
static const int64_t POOL_FEE_AMOUNT = (0.1*COIN); //0.1 HSC
static const int64_t DARKSEND_POOL_MAX = (22000*COIN); //22,000 HSC
...
// General Hashimocoin Block Values

static const int LAST_POW_BLOCK = 5000000; // Block 5m Approx. 5 years of Proof of Work before Proof of Stake consensus kicks in
static const int FAIR_LAUNCH_BLOCK = 5000; // Last Block until full block reward starts
...
static const int64_t MAX_MONEY = 100000000 * COIN; // 100,000,000 HSC Hashimocoin Max
static const int64_t COIN_YEAR_REWARD = 0.25 * COIN; // 25% per year

static const int64_t MAINNET_POSFIX = 5001; //Mainnet Proof of Stake update not enabled until block 5001
...
static const uint256 hashGenesisBlock("0x000004f5bae991875c8cd721c7d72f859d91111cee8b6542883c7868c9abd084");
static const uint256 hashGenesisBlockTestNet("0x0000f0268bb232a3d96abe23a61a79344e706d4a18f9f0e6dd05fe2e44684625");
...
inline int64_t GetMNCollateral() { return 10000; }
