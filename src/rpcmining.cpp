...
Value getworkex(const Array& params, bool fHelp)
{
    ...
    if (vNodes.empty())
        throw JSONRPCError(-9, "Hashimocoin is not connected!");

    if (IsInitialBlockDownload())
        throw JSONRPCError(-10, "Hashimocoin is downloading blocks...");
...
Value getwork(const Array& params, bool fHelp)
{
    ...
    if (vNodes.empty())
        throw JSONRPCError(RPC_CLIENT_NOT_CONNECTED, "Hashimocoin is not connected!");

    if (IsInitialBlockDownload())
        throw JSONRPCError(RPC_CLIENT_IN_INITIAL_DOWNLOAD, "Hashimocoin is downloading blocks...");
...
Value getblocktemplate(const Array& params, bool fHelp)
{
    ...
    if(!masternodePayments.GetBlockPayee(pindexPrev->nHeight+1, payee)){
        ...
        if(winningNode >= 0){
            ...
            else burnAddress = "HSCXXXXXXXXXXXXXXXXXXXXXXXXXZeeDTw";
